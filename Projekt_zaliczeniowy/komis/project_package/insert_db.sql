...
INSERT INTO samochod (nr_rejestracyjny, nr_vin, marka, model, rocznik, przebieg, silnik, paliwo, moc, kolor, rodzaj_pojazdu, ladownosc, gotowy_do_sprzedaży, opis, id_plac)
VALUES 
('ABC1234', '1HGCM82633A123456', 'Toyota', 'Corolla', 2015, 80000, 1.8, 'Benzyna', 140, 'Czarny', 'Sedan', 5.0, true,'Polski salon', 1),
('DEF5678', '2HGCM82633A654321', 'Honda', 'Civic', 2018, 60000, 2.0, 'Benzyna', 158, 'Biały', 'Sedan', 4.5, false,'Dodatkowy komplet opon', 2),
('GHI9101', '3HGCM82633A987654', 'Ford', 'Focus', 2020, 30000, 1.5, 'Diesel', 120, 'Niebieski', 'Hatchback', 4.0, true,'Brak drugiego kluczyka', 1),
('POL2345', '4HGCM82633A456789', 'Volkswagen', 'Golf', 2016, 90000, 1.6, 'Benzyna', 110, 'Srebrny', 'Hatchback', 4.3, false,null, 3),
('MNO6789', '5HGCM82633A112233', 'BMW', '3 Series 4x4', 2017, 70000, 2.0, 'Diesel', 190, 'Czerwony', 'Sedan', 4.8, true,null, 2),
('PQR1122', '6HGCM82633A332211', 'Audi', 'A4', 2019, 50000, 2.0, 'Benzyna', 200, 'Czarny', 'Sedan', 4.7, false,'Dodatkowy komplet opon', 3),
('STU3344', '7HGCM82633A223344', 'Mercedes', 'C-Class', 2018, 65000, 2.0, 'Diesel', 180, 'Biały', 'Sedan', 4.6, true, null, 1),
('VWX5566', '8HGCM82633A445566', 'Skoda', 'Octavia', 2021, 20000, 1.4, 'Benzyna', 150, 'Zielony', 'Hatchback', 4.2, false,'Dodatkowo CB radio', 2),
('YZA7788', '9HGCM82633A667788', 'Volvo', 'S60 4x4', 2016, 85000, 2.0, 'Diesel', 190, 'Srebrny', 'Sedan', 4.9, true,null, 3),
('POD9900', '0HGCM82633A889900', 'Mazda', '6 4x4', 2017, 75000, 2.2, 'Diesel', 175, 'Niebieski', 'Sedan', 4.5, false,null, 1),
('EFG1235', '1HGCM82633B112233', 'Opel', 'Astra', 2020, 25000, 1.6, 'Benzyna', 130, 'Czerwony', 'Hatchback', 4.1, true,null, 2),
('HIJ4567', '2HGCM82633B445566', 'Renault', 'Megane', 2019, 40000, 1.5, 'Diesel', 115, 'Biały', 'Hatchback', 4.0, false,null, 3),
('KLM7890', '3HGCM82633B778899', 'Peugeot', '308', 2018, 55000, 1.2, 'Benzyna', 130, 'Czarny', 'Hatchback', 4.2, true,'Brak drugiego kluczyka', 1),
('POP1123', '4HGCM82633C112233', 'Hyundai', 'Elantra', 2021, 15000, 1.8, 'Benzyna', 147, 'Srebrny', 'Sedan', 4.5, false,'Dodatkowy komplet opon', 2),
('QRC4456', '5HGCM82633C445566', 'Kia', 'Ceed', 2017, 70000, 1.6, 'Diesel', 136, 'Niebieski', 'Hatchback', 4.3, true,'Polski salon', 3);
