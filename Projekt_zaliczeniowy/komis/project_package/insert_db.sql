...
('POL2345', '4HGCM82633A456789', 'Volkswagen', 'Golf', 2016, 90000, 1.6, 'Benzyna', 110, 'Srebrny', 'Hatchback', 4.3, false, 3),
('MNO6789', '5HGCM82633A112233', 'BMW', '3 Series 4x4', 2017, 70000, 2.0, 'Diesel', 190, 'Czerwony', 'Sedan', 4.8, true, 2),
...
('YZA7788', '9HGCM82633A667788', 'Volvo', 'S60 4x4', 2016, 85000, 2.0, 'Diesel', 190, 'Srebrny', 'Sedan', 4.9, true, 3),
('POD9900', '0HGCM82633A889900', 'Mazda', '6 4x4', 2017, 75000, 2.2, 'Diesel', 175, 'Niebieski', 'Sedan', 4.5, false, 1),
...
('POP1123', '4HGCM82633C112233', 'Hyundai', 'Elantra', 2021, 15000, 1.8, 'Benzyna', 147, 'Srebrny', 'Sedan', 4.5, false, 2),
('QRC4456', '5HGCM82633C445566', 'Kia', 'Ceed', 2017, 70000, 1.6, 'Diesel', 136, 'Niebieski', 'Hatchback', 4.3, true, 3);
...
('F/2024/002', 2500.00, 'EUR', null, 'Gotówka', true),
...
INSERT INTO kartoteka_transakcji (rodzaj, data_transakcji, samochod_w_rozliczeniu, uwagi, id_samochod, id_klient, id_sprzedawca, id_plac, id_faktura)
VALUES 
('sprzedaż', '2024-01-15', true, 'Samochód kupiony z rabatem', 2, 10, 2, 1, 2);
...
INSERT INTO kartoteka_transakcji (rodzaj, data_transakcji, samochod_w_rozliczeniu, uwagi, id_samochod, id_klient, id_sprzedawca, id_plac, id_faktura)
VALUES 
('kupno', '2024-04-01', true, 'Samochód w rozliczeniu', 7, 9, 7, 3, 7);
